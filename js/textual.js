...
(function(exports){
    ...
    exports.squish = function(text){ // compress all whitespace
    ...
    exports.bag = function(sequence){
      return Object.keys(textual.frequency(sequence)); 
    };
    ...
    exports.trigrams = function(text) { 
      return exports.ngrams(3, text)
    };
